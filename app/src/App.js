...
import { Experience } from './components/employeeUI/ExperienceGoals';
import { Goals } from './components/employeeUI/ExperienceGoals';
  ...
  return (
      ...
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/experience_goals" element={<Experience />}/>
