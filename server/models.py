...
class Employee(db.Model):
    ...
    dept_id=db.Column(db.String,db.ForeignKey('departments.id'),nullable=False)
...
class ManagerProfile(db.Model):
     ...
     id=db.Column(db.String,primary_key=True,default=generate_uuid)
     date_of_birth=db.Column(db.DateTime,nullable=False)
     manager_id=db.Column(db.String,db.ForeignKey('managers.id'),nullable=False)     
     first_name=db.Column(db.String(30),nullable=False)
     last_name=db.Column(db.String(30),nullable=False)
     mantra=db.Column(db.String(),nullable=False)
     phone_contact=db.Column(db.Integer,nullable=False)
...
class HrProfile(db.Model):
     ...
     id=db.Column(db.String,primary_key=True,default=generate_uuid)
     date_of_birth=db.Column(db.DateTime,nullable=False)
     hr_id=db.Column(db.String,db.ForeignKey('hr_personnels.id'),nullable=False)     
     first_name=db.Column(db.String(30),nullable=False)
     last_name=db.Column(db.String(30),nullable=False)
     mantra=db.Column(db.String,nullable=False)
     phone_contact=db.Column(db.Integer,nullable=False)
...
class RemunerationDescription(db.Model):
     ...
     id=db.Column(db.String,primary_key=True,default=generate_uuid)
     remuneration_id=db.Column(db.String,db.ForeignKey('remunerations.id'),nullable=False)  
     type = db.Column(Enum("deduction", "bonus", "allowance", "normal"), nullable=False)
     name=db.Column(db.String(30),nullable=False)
...
class EmployeeTraining(db.Model):
      ...
      id=db.Column(db.String,primary_key=True,default=generate_uuid)    
      employee_id=db.Column(db.String,db.ForeignKey('employees.id'),nullable=False)   
      training_id=db.Column(db.String,db.ForeignKey('trainings.id'),nullable=False)   
