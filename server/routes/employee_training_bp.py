...
post_args.add_argument('training_id', type=str, required=True, help='Training ID is required')
...
class EmployeeTrainingsResource(Resource):
    ...
    def post(self):
        ...
        # error handling
        employee_training = EmployeeTraining.query.filter_by(employee_id=data.employee_id, training_id=data.training_id).first()
        ...
        new_employee_training = EmployeeTraining(employee_id=data['employee_id'], training_id=data['training_id'])
...
class EmployeeTrainingById(Resource):
    def get(self, id):
        single_employee_training = EmployeeTraining.query.filter_by(id=id).first()
