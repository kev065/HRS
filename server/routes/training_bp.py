...
post_args.add_argument('title', type=str, required=True, help='Training title is required')
...
class TrainingsResource(Resource):
    ...
    def post(self):
        ...
        new_training = Training(title=data['title'], description=data['description'], start_date=data['start_date'], start_time=data['start_time'], end_date=data['end_date'], end_time=data['end_time'])
