...
post_args.add_argument('name', type=str, required=True, help='Goal name is required')
...
get_args.add_argument('employee_id', type=str, required=True, help='Employee ID is required')
get_args.add_argument('quarter', type=str, required=True, help='Quarter Name is required')

patch_args = reqparse.RequestParser()
patch_args.add_argument('employee_id', type=str, required=True, help='Employee ID is required')
patch_args.add_argument('name', type=str, required=True, help='Goal name is required')
patch_args.add_argument('description', type=str, required=True, help='Description is required')
patch_args.add_argument('session_id', type=str, required=True, help='Session ID is required')
...
class GoalsSessionResource(Resource):
    def get(self):
        ...
        goals = Goals.query.filter_by(employee_id=data['employee_id'], session_id=session.id).all()
        if not goals:
